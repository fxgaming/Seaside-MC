...
public class CommandMe extends BasedCommand {
		...
		if (Seaside.SERVER) {
			if (var1 instanceof EntityPlayer) {
				...
				if (!Punishments.instance.hasMute(var3)) {
					if (var2.length > 0) {
						String message = "§d " + var1.getCommandSenderName() + "[" + Seaside.getID(var3.getEntityName()) + "] " + Utils.sculptString(var2);
						...
						var3.sendChatToPlayer("§c[Использование]§f /me [действие]");
					}
				} else {
					//TODO: MUTE
				}
			} else {
				var1.sendChatToPlayer("/me - nope!");
			}
		}
	}
}
